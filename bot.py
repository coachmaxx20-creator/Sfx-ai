...
# ── PAIRS ─────────────────────────────────────
PAIRS = ["EURUSD-OTC","GBPUSD-OTC","USDJPY-OTC","EURJPY-OTC","GBPJPY-OTC","AUDUSD-OTC","USDCAD-OTC","EURGBP-OTC","EURAUD-OTC","AUDJPY-OTC"]
PAIR_LABELS = {
    "EURUSD-OTC":"EUR/USD (OTC)","GBPUSD-OTC":"GBP/USD (OTC)",
    "AUDUSD-OTC":"AUD/USD (OTC)","USDJPY-OTC":"USD/JPY (OTC)","EURJPY-OTC":"EUR/JPY (OTC)","GBPJPY-OTC":"GBP/JPY (OTC)",
    "USDCAD-OTC":"USD/CAD (OTC)","EURGBP-OTC":"EUR/GBP (OTC)","EURAUD-OTC":"EUR/AUD (OTC)","AUDJPY-OTC":"AUD/JPY (OTC)"
}
